...
# args 
- maxpages: the bot scrapes the alphabetical list of all products first, only then start scraping nutrition data of particular products. maxpages tells how many pages of the list it should go for. 
